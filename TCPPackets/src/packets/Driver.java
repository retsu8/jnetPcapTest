...
public class Driver {  
    ...
    public static void main(String[] args) {  
        ...
        final String FILENAME = args[2]; //"tests/lbl-internal.20041004-1305.port002.dump.pcap";  
        ...
        pcap.loop(10, new JPacketHandler<StringBuilder>() {  
            ...
            public void nextPacket(JPacket packet, StringBuilder errbuf) {  
                ...
                if (packet.hasHeader(Tcp.ID)) {  
                    ...
                    System.out.printf("tcp.dst_port=%s%n", tcp.destination());  
                    System.out.printf("tcp.src_port=%d%n", tcp.source());
                    System.out.println("Flag number = " + tcp.flags());
...
//        final Map<JFlowKey, JFlow> flows = new HashMap<JFlowKey, JFlow>();  
        ...
        for (int i = 0; i < 50; i++) {  
            ...
            System.out.println(key.getPairP1(0, true) + " --> " + key.getPairP1(3, true)); //[0] + " --> " + key.getPairs()[1]);
            /* 
...
//        final String FILENAME = args[1]; //"tests/lbl-internal.20041004-1305.port002.dump.pcap";  
//        final StringBuilder errbuf = new StringBuilder();  
//  
//        final Pcap pcap = Pcap.openOffline(FILENAME, errbuf);  
//        if (pcap == null) {  
...
//        while (j < 50) {
//           
//            //if (tcp.hasNextHeader()) {
//                System.out.println("Packet# " + (j+1));
//                System.out.println("Source   = " + tcp.source());
//                System.out.println("Receiver = " + tcp.destination());
//                System.out.println();
//            //}
//            
//            j++;
